...
/**
 * Class AddElectricAllKfl 한국식품연구원 전기 층,룸 사용량 조회
 */
class AddElectricAllKfl extends Command
{
    /** @var string|2019 $complexCodePk 단지번호 */
    private string$complexCodePk = '2019';
