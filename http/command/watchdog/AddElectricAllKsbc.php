...
/**
 * Class AddElectricAllKsbc 김해 소상공인 물류센터 전기 층,룸 사용량 조회
 */
class AddElectricAllKsbc extends Command
{
    /** @var string|2010 $complexCodePk 단지번호 */
    private string $complexCodePk = '2012';

    /** @var int|0 $option 에너지원, 전기를 의미 */
    private int $option = 0;

    /**
     * AddElectricAllKsbc Constructor.
     */
