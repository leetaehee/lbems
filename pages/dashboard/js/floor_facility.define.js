...
const command = 'dashboard_floor_facility';
...
let chartPieUse = createUseAndDistributionPieChart(canvasUsePieEnergy);
...
const canvasColors = [CURRENT_COLOR, PREDICT_COLOR];
const canvasLabels = ['금일 현재 사용량', '금일 예상 사용량'];
