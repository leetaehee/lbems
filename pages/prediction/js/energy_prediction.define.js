...
const command = "energy_prediction";
...
const homeTypes = CONFIGS['floor'];
const PERIOD_KEYS = ['daily', 'weekly', 'month'];
const LEGEND_KEYS = ['current', 'predict']
const DEFAULT_LEGEND = ['금일 현재 사용량', '금일 예상 사용량'];
...
// DIV
//----------------------------------------------------------------------------------------------
const $divChartLegendFloor = $("#div_chart_legend_floor");
