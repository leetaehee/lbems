...
declare module DevExpress.ui {
    ...
    /** The FilterBuilder widget allows a user to build building filter expressions with an unlimited number of filter conditions, combined by logical operations using the UI. */
    ...
    export interface GridBaseColumn {
        ...
        ownerBand?: number;
        /** Specifies whether to render the column after other columns and elements. Use if column cells have a building template. Requires the width option specified. */
        renderAsync?: boolean;
