...
function createControl()
{
    let control = {
        ...
        request: function(showLoadingBar = true)
        {
            ...
            data.push({ name: 'floor_type', value: $selectFloorType.val() });
        ...
        updateDeviceStatus: function()
        {
            ...
            let powerOnOffStatus = statusData['power'];
            let temperature = parseInt(statusData['set_temperature']);
            let fanSpeed = statusData['fan_speed'];
            let mode = statusData['op_mode'];
